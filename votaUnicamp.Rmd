...
Podemos fazer algumas análises exploratórias para estudar o comportamento dos nossos dados. Uma das maneiras que encontramos para isso foi mapear o campus da Unicamp a fim de ver qual o posicionamento de cada instituto. Temos abaixo o mapeamento de acordo com a proporção de votos contrários à greve por instituto, quanto mais vermelho o indicador menor a proporção e quanto mais azul maior a proporção.
